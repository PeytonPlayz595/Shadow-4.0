...
public class GuiShadowExperimental extends GuiScreen {
	
	private static GameSettings.Options[] enumOptions = new GameSettings.Options[] {GameSettings.Options.VIS_GRAPH, GameSettings.Options.BUFFER_QUEUE};
	
	private GuiScreen parentScreen;
	protected String title;
	
	public GuiShadowExperimental(GuiScreen screen) {
	 ...
	 */
	public void initGui() {
		this.title = I18n.format("Shadow Client (Experimental Settings)", new Object[0]);
