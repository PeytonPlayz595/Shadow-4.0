...
public class SetVisibilityExperimental {

	private static final int COUNT_FACES = EnumFacing.values().length;
	private final BitSet bitSet;

	public SetVisibilityExperimental() {
	...
	public boolean equals(Object o) {
		...
		if (o instanceof SetVisibilityExperimental) {
			return ((SetVisibilityExperimental) o).bitSet.equals(bitSet);
		}
		return false;
	}
	...
	@Override
	public SetVisibilityExperimental clone() {

		SetVisibilityExperimental r = new SetVisibilityExperimental();
		r.bitSet.or(bitSet);
		return r;
	}
