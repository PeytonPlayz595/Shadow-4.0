...
//                BakedQuad bakedquad1 = new BakedQuad(bakedquad.getVertexData().clone(), bakedquad.getVertexDataWithNormals().clone(), bakedquad.getTintIndex(), bakedquad.getFace(), bakedquad.getSprite());
