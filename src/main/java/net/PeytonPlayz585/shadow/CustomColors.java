...
public class CustomColors {
    ...
    public static void update() {
        ...
        if (Config.isCustomColors()) {
            ...
            String[] astring11 = new String[] {
                "myceliumparticle.png",
                "myceliumparticlecolor.png"
            };
            ...
            blockColormaps = readBlockColormaps(new String[] {
                s + "custom/", s + "blocks/"
    ...
    private static CustomColormap[][] readBlockColormaps(String[] basePaths, CustomColormap[] basePalettes, int width, int height) {
        String[] astring = ResUtils.collectFiles(basePaths, new String[] {
            ".properties"
        });
            ...
            if (s.startsWith(prefix)) {
                ...
                if (enumdyecolor1 != null && j >= 0) {
                    float[] afloat = new float[] {
                        (float)(j >> 16 & 255) / 255.0F, (float)(j >> 8 & 255) / 255.0F, (float)(j & 255) / 255.0F
                    };
