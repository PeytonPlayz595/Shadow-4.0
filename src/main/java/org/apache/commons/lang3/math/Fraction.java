...
/**
 * <p>
 * {@code Fraction} is a {@code Number} implementation that stores fractions
 * accurately.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * Note that this class is intended for common use cases, it is <i>int</i> based
 * and thus suffers from various overflow issues. For a BigInteger based
...
public final class Fraction extends Number implements Comparable<Fraction> {
	 ...
	 *                             denominator is {@code negative} and the numerator
	 *                             is {@code Integer#MIN_VALUE}
	 */
	 ...
	 * </p>
	 *
	 * @param whole       the whole number, for example the one in 'one and three
	 *                    sevenths'
	 * @param numerator   the numerator, for example the three in 'one and three
	 *                    sevenths'
	 * @param denominator the denominator, for example the seven in 'one and three
	 *                    sevenths'
	 * @return a new fraction instance
	 ...
	 * the "binary gcd" method which avoids division and modulo operations. See
