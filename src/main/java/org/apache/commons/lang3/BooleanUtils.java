...
public class BooleanUtils {
	 ...
	 *
	 * <p>
	 * {@code 'true'}, {@code 'on'}, {@code 'y'}, {@code 't'}, {@code 'yes'} or
	 * {@code '1'} (case insensitive) will return {@code true}. {@code 'false'},
	 * {@code 'off'}, {@code 'n'}, {@code 'f'}, {@code 'no'} or {@code '0'} (case
	 * insensitive) will return {@code false}. Otherwise, {@code null} is returned.
	 * </p>
	 *
	 * <p>
	 * NOTE: This method may return {@code null} and may throw a
